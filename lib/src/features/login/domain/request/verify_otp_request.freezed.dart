...
abstract class $VerifyOtpRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call({String pin, String pinId});
}
...
class _$VerifyOtpRequestImpl implements _VerifyOtpRequest {
  const _$VerifyOtpRequestImpl({required this.pin, required this.pinId});
  ...
  @override
  String toString() {
    return 'VerifyOtpRequest(pin: $pin, pinId: $pinId)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, pin, pinId);
...
abstract class _VerifyOtpRequest implements VerifyOtpRequest {
  const factory _VerifyOtpRequest(
      ...
      required final String pinId}) = _$VerifyOtpRequestImpl;
