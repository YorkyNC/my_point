...
/// @nodoc
@JsonSerializable()
class _$RefreshTokenResponseImpl extends _RefreshTokenResponse {
  ...
  @override
  String toString() {
    return 'RefreshTokenResponse(status: $status, meta: $meta, data: $data)';
  }
...
abstract class _RefreshTokenResponse extends RefreshTokenResponse {
  const factory _RefreshTokenResponse(
      {required final String status,
      required final Map<String, dynamic> meta,
      required final TokenResponse data}) = _$RefreshTokenResponseImpl;
  const _RefreshTokenResponse._() : super._();
